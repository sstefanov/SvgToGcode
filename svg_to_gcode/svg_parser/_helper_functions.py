...
def parse_root_path(root: ElementTree.Element, canvas_height=None, transform=True, draw_hidden=False, _visible_root=True) \
        -> List[Curve]:
    ...
    if draw_hidden:
        ...
        for element in list(root):
            ...
            # Continue the recursion
            curves.extend(parse_root_path(element, canvas_height, transform, False, visible))
